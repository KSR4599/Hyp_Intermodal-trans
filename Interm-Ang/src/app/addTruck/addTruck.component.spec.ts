...
describe('addTruckComponent', () => {
  ...
  let mockaddTruckService;
  let mockDataService

  beforeEach(async(() => {

    mockaddTruckService = sinon.createStubInstance(addTruckService);
    mockaddTruckService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: addTruckService, useValue: mockaddTruckService },
