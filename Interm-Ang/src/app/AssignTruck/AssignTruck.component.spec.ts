...
import { AssignTruckComponent } from './AssignTruck.component';
...
describe('AssignTruckComponent', () => {
  ...
  let mockAssignTruckService;
  let mockDataService

  beforeEach(async(() => {

    mockAssignTruckService = sinon.createStubInstance(AssignTruckService);
    mockAssignTruckService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: AssignTruckService, useValue: mockAssignTruckService },
