...
describe('truckDetailsComponent', () => {
  ...
  let mocktruckDetailsService;
  let mockDataService

  beforeEach(async(() => {

    mocktruckDetailsService = sinon.createStubInstance(truckDetailsService);
    mocktruckDetailsService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: truckDetailsService, useValue: mocktruckDetailsService },
