...
describe('CreateContainerComponent', () => {
  ...
  let mockCreateContainerService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateContainerService = sinon.createStubInstance(CreateContainerService);
    mockCreateContainerService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateContainerService, useValue: mockCreateContainerService },
