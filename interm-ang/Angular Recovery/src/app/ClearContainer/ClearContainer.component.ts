...
@Component({
  ...
  templateUrl: './ClearContainer.component.html',
  styleUrls: ['./ClearContainer.component.css'],
  providers: [ClearContainerService]
})
export class ClearContainerComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceClearContainer.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    ...
    .then(() => {
      ...
      this.spinner = '';
      this.successMessage= 'Cleared the Container!👍';
    })
    .catch((error) => {
      if (error === 'Server error') {
        this.errorMessage = 'Could not connect to REST server. Please check your configuration details';
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceClearContainer.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceClearContainer.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
