...
import { LoadContainerComponent } from './LoadContainer.component';
...
describe('LoadContainerComponent', () => {
  ...
  let mockLoadContainerService;
  let mockDataService

  beforeEach(async(() => {

    mockLoadContainerService = sinon.createStubInstance(LoadContainerService);
    mockLoadContainerService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: LoadContainerService, useValue: mockLoadContainerService },
